  ...
  export let blockData: Record<string, any>[] = [
    {
      ...
      StartTime: new Date(2022, 10, 22, 12, 0),
      EndTime: new Date(2022, 10, 22, 16, 0),
      IsAllDay: false,
      IsBlock: true,
      EmployeeId: 2
    }, {
      ...
      Id: 4,
      Subject: 'Client Meeting',
      StartTime: new Date(2022, 10, 24, 12, 0),
      EndTime: new Date(2022, 10, 24, 16, 0),
      IsAllDay: false,
      IsFirstHalf: false,
      IsBlock: false,
      IsSecondHalf:false,
      ...
      Id: 12,
        Subject: '',
        StartTime: new Date(2019, 10, 2, 15, 0),
        EndTime: new Date(2019, 10, 2, 17, 0),
